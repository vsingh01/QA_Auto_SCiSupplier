...
public class BuyerTestNG7 extends PRBase	{
	...
	public void buyertest1() throws Exception {
		...
		SCiSupplierBuyerMenu testMenu = PageFactory.initElements(Browser.eDriver,
				SCiSupplierBuyerMenu.class);
			
		VerifyBuyerPagesReports testMenu1 = PageFactory.initElements(Browser.eDriver,
				VerifyBuyerPagesReports.class);
