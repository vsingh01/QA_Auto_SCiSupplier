...
public class SCiSupplierCOMMenu {
	...
	@FindBy(xpath = "//table[@id='rowBuyerPerformance']/tbody/tr[2]/td[3]/a")
	...
	public void resetTargetCreditCapacity() {
		 ...
		 * //html/body/div[1]/div/div/div/div/table[4]/tbody/tr/td[2]/div[2]/
		 ...
		 * 
		 * String xpath_Start =
		 * ("html/body/div[1]/div/div/div/div/table[4]/tbody/tr/td[2]/div[2]/table/tbody/tr["
		 * ); String xpath_End = ("]/td[1]/a"); int i=1;
		 * 
		 * while(SeleniumUtils.isElementPresent(xpath_Start+i+xpath_End)) {
		 * String buyerName =
		 * Browser.eDriver.findElement(By.xpath(xpath_Start+i+xpath_End)).
		 * getText(); if(buyerName.equalsIgnoreCase("rktbuyer2")) { logger.info(
		 * "Buyer Name Found : : : : :" + buyerName);
		 * 
		 * //Browser.eDriver.findElement(By.xpath(xpath_Start+i+xpath_End)).
		 * click();
		 * 
		 ...
		 * //html/body/div[1]/div/div/div/div/table[4]/tbody/tr/td[2]/div[2]/
		 * table/tbody/tr[3]/td[3]/a
		 * 
		 * 
		 * String buyerProgramView =
		 * Browser.eDriver.findElement(By.xpath(xpath_Start+i+xpath_End.replace(
		 * "td[1]","td[3]"))).getText();
		 * 
		 * if (buyerProgramView.equalsIgnoreCase("View")) { logger.info(
		 * "Buyer Program Found : : : : :" + buyerProgramView);
		 * Browser.eDriver.findElement(By.xpath(xpath_Start+i+xpath_End.replace(
		 * "td[1]","td[3]"))).click(); break; }
		 * 
		 * } i++;
		 * 
		 * }
	...
	public void menuToUsers() {
		...
		logger.info("Community Home Title verified : : :" + spTitle);
